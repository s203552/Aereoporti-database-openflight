...
public class Route {
	...
	public int getSourceAirportId() {		return sourceAirportId;	}
	public void setSourceAirportId(int sourceAirportId) {		this.sourceAirportId = sourceAirportId;	}
	...
	public boolean equals(Object obj) {
		...
		if (destinationAirportId != other.destinationAirportId)		return false;
		if (sourceAirportId != other.sourceAirportId)		return false;
		return true;
	}
	@Override
